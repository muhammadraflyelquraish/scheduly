        ...
        <ul class="nav metismenu" id="side-menu">
            ...
            @if ($role == 'Admin' || $role == 'Staff')
                <li class="{{ request()->routeIs('class.index') ? 'active' : '' }}">
                    <a href="{{ route('class.index') }}"><i class="fa fa-university"></i> <span
                            class="nav-label">Kelas</span></a>
                </li>

                <li class="{{ request()->routeIs('matkul.index') ? 'active' : '' }}">
                    <a href="{{ route('matkul.index') }}"><i class="fa fa-book"></i> <span
                            class="nav-label">Matkul</span></a>
                </li>
            @endif

            <li
                class="{{ (request()->routeIs('schedule.index') or
                request()->routeIs('schedule.show') or
                request()->routeIs('schedule-detail.create'))
                    ? 'active'
                    : '' }}">
                <a href="{{ route('schedule.index') }}"><i class="fa fa-calendar"></i> <span
                        class="nav-label">Jadwal</span></a>
            </li>

            @if ($role == 'Admin')
                <li class="{{ request()->routeIs('user.index') ? 'active' : '' }}">
                    <a href="{{ route('user.index') }}"><i class="fa fa-user"></i> <span
                            class="nav-label">User</span></a>
                </li>
            @endif

            <li class="special_link">
                <a href="javascript:void(0)" id="logout"><i class="fa fa-sign-out"></i> <span
